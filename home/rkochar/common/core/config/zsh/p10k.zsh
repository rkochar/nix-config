# Generated by Powerlevel10k configuration wizard on 2025-09-29 at 13:01 CEST.
...
() {
  ...
  ### My Nix ###
  # POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS+=nix_shell_name
  # POWERLEVEL9K_NIX_SHELL_NAME_FOREGROUND=24

  # https://github.com/romkatv/powerlevel10k/issues/515
  function prompt_my_nix_shell() {
    [[ -n ${IN_NIX_SHELL} ]] || return 1
    if [[ ! -z "$name" ]]; then
      p10k segment -f 74 -i $'\uF313' -t "${name%_dev_shell}"
    fi
  }
  ...
  # https://github.com/indirect/dotfiles/blob/main/dot_p10k.zsh#L1188-L1331
